function processPokemon(results) {
  ...
  var nameImg = results.name.toLowerCase();

  var URL = `https://courses.cs.washington.edu/courses/cse154/webservices/pokedex/images/${nameImg}.jpg`;

  var card = `<div class="card" id="zeca" style="width: 18rem;"><div class="imageDiv"><img src="${URL}" class="card-img-top" alt="${name}"></div>
        <div class="card-body">
